...
from tkinter import *
#defining attribute of main window
...
def result():
           try:
                   ...
                   # using lambda instead of function to make the use of buttons more clear
                   ...
                   eight = Button(text="9",width=2,command=lambda:inp.insert("end","9"),borderwidth=3,relief=RIDGE)
                   ...
                   six = Button(root,text="6",width=2,command=lambda:inp.insert("end","6"),borderwidth=3,relief=RIDGE)   
                   six.grid(row=2,sticky="w",padx=15,pady=5) 

                   five = Button(root,text="5",width=2,command=lambda:inp.insert("end","5"),borderwidth=3,relief=RIDGE)   
                   ...
                   three = Button(root,text="3",width=2,command=lambda:inp.insert("end","3"),borderwidth=3,relief=RIDGE)   
                   three.grid(row=3,sticky="w",padx=15,pady=5)

                   two = Button(root,text="2",width=2,command=lambda:inp.insert("end","2"),borderwidth=3,relief=RIDGE)   
                   two.grid(row=2,sticky="w",padx=45,pady=5) 

                   one = Button(root,text="1",width=2,command=lambda:inp.insert("end","1"),borderwidth=3,relief=RIDGE)   
                   one.grid(row=2,sticky="w",padx=75,pady=5) 
                   ...
                   zero = Button(root,text="0",width=2,command=lambda:inp.insert("end","0"),borderwidth=3,relief=RIDGE)   
                   six.grid(row=4,sticky="w",padx=15,pady=5) 

                   double_zero = Button(root,text="00",width=2,command=lambda:inp.insert("end","00"),borderwidth=3,relief=RIDGE)   
                   ...
                   result = Button(root,text="=",width=2,command=lambda:inp.insert("end","="),borderwidth=3,relief=RIDGE)   
                   ...
                   modulus.grid(row=5,sticky="w",padx=15,pady=5) 
